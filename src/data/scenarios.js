...
rectalForeignBody: {cat: "medical", id: "MISC-043", pronouns: "he", title: "Male, 34. Abdominal/rectal pain, won't say why.",
  limit: 900, transport: 420,
  bystanders: "His roommate called it in from the hallway. \"He just said his stomach hurts and to call an ambulance. He wouldn't let me in the bathroom.\"",
  units: [],
  dispatch: ["34M, abdominal pain, patient declined to elaborate to caller.", "Found in the bathroom, sitting, guarding."],
  update: ["He asks the crew to step out into the hallway for a minute before you can finish the exam."],
  impression: "Sitting rigidly on the edge of the tub, guarding his lower abdomen, avoiding eye contact. Alert, oriented, clearly embarrassed and reluctant to describe the complaint in detail.",
  imps: ["ABDP"],
  patient: {age: 34, hr: 96, sbp: 128, rr: 18},
  clothing: {top: "short", bottom: "pants", shoes: false},
  seed: () => ({}),
  probes: {
    opqrst: () => ({say: "Once the roommate steps out: \"It's... I put something up there and now I can't get it back out. It's been like three hours. It hurts more now than when it started, and I feel like I really need to go but I can't.\" No blood he's noticed.", kind: "pt",
      evid: "A retained rectal foreign body presenting hours after insertion, with worsening pain and a sense of incomplete evacuation, is the classic history — the real danger is a missed bowel perforation, not the object itself. Rising, worsening, diffuse abdominal pain (rather than pain confined to where the object sits) is the finding that should raise concern for perforation.", find: "OPQRST: retained rectal foreign body, ~3h, worsening pain, no observed bleeding, unable to evacuate."}),
    sample: () => ({say: "\"No allergies, no meds, nothing like this before. I haven't been drinking or using anything. I just need someone to help me, I'm not trying to make a big deal of it.\"", kind: "pt",
      evid: "A clear, embarrassed but coherent history with no intoxication and no prior episodes is reassuring against an altered-mental-status confound, but does not itself rule out perforation — that call rests on the abdominal exam and vitals trend, not on how the patient is telling the story.", find: "SAMPLE: NKDA, no meds, no prior episodes, denies intoxication."}),
    abdo: () => ({say: "Abdomen is soft, mildly tender low in the midline, no rebound or rigidity, no distension.", kind: "obs",
      evid: "A soft, non-rigid, non-distended abdomen without rebound tenderness argues against perforation and free peritoneal contamination at this point in the call — a finding that could change quickly if this becomes a longer transport or a delayed presentation, which is exactly why a repeat abdominal exam before and after transport matters here.", find: "Abdomen soft, mild low midline tenderness, no rebound/rigidity/distension."}),
    skin: () => ({say: "Warm, dry, mildly flushed from embarrassment. No diaphoresis, no pallor.", kind: "obs", evid: "No diaphoresis or pallor argues against significant hemorrhage or a developing septic/peritonitic picture right now.", find: "Warm and dry, no diaphoresis or pallor."}),
  },
  resolve: (s) => ({died: false, cause: "",
    notes: ["A retained rectal foreign body is one of the more common calls patients delay reporting accurately out of embarrassment — the real clinical risk isn't the object itself, it's a missed bowel perforation from the insertion or from the object's own edges.",
      "There is no field procedure to remove it, and attempting one is not within scope and risks worsening any perforation or converting a partial injury into a full-thickness one. The prehospital job is a good abdominal exam, treating pain within scope, and a non-judgmental, discreet transport to a facility that can image and remove it safely.",
      "A rigid, distended, or worsening abdomen, fever, or hemodynamic instability at any point should be treated as a possible perforation and escalated accordingly, even though none of those signs are present here.",
      "Patients delay calling and then minimize the story out of embarrassment far more often with this complaint than with almost any other. Privacy, a non-judgmental tone, and asking directly are what actually get you the history you need to assess for the real danger."],
    correct: s.pi === "ABDP", truth: "Retained rectal foreign body — an embarrassment-delayed presentation whose real danger is an occult bowel perforation"}),
},
